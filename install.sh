#!/bin/sh
# install.sh — install iconlens from GitHub.
#
#   curl -fsSL https://raw.githubusercontent.com/srivtx/iconlens/main/install.sh | sh
#
# Installs the `iconlens` binary globally with Bun. Pass a git ref as the
# first argument to pin a branch, tag, or commit:
#
#   curl -fsSL https://raw.githubusercontent.com/srivtx/iconlens/main/install.sh | sh -s v0.1.0
set -eu

REPO="srivtx/iconlens"
BIN="iconlens"
REF="${1:-main}"
